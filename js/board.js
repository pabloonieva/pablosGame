...
Board.prototype.drawSkyline = function () {
  ...
  this.ctx.drawImage(this.backgroundImage, 2, 2, this.backgroundImage.width, this.backgroundImage.height, this.imagex - this.backgroundImage.width*2, this.imagey, this.backgroundImage.width*3, this.backgroundImage.height*3);
